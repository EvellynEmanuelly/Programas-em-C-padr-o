...
int main(void)
{
    ...
    do
    {
        ...
        // Solicita ao usuário o valor da compra até que seja fornecido um valor válido
        do
        {
            printf("Valor da compra: ");
            if (scanf("%f", &valorCompra) != 1)
            {
                while (getchar() != '\n')
                    ;
        ...
        // Solicita ao usuário o valor pago até que seja fornecido um valor válido
        do
        {
            printf("Valor pago: ");
        ...
        int moedas1 = 0, moedas50 = 0, moedas25 = 0, moedas10 = 0, moedas5 = 0;
        ...
        // Imprime o valor total do troco
        printf("Valor total do troco: R$%.2f\n", trocoFloat);

        // Imprime a quantidade total que sairá do caixa
        int totalMoedasNotas =
            notas100 + notas50 + notas20 + notas10 + notas5 + notas2 + moedas1 + moedas50 + moedas25 + moedas10 + moedas5;
